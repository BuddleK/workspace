...
//		1. 바깥 for문 시작
//		1-1) 초기식 i를 1로 초기화,
//			조건식 i < 3조건을 검사해서 1 < 3 true이면 바깥for문 중괄호 영역 안으로 들어간다
//		2. 안쪽 for문 시작
//		2-1) 초기식 j를 1로 초기화
...
//		5-2) 조건식	i < 3 조건 검사 => 2 < 3 true이면 바깥for문 중괄호 영역안으로 들어간다
//		6. 안쪽 for문 시작
//		2~5계속 반복
//		+) 바깥for문의 증감식으로 이동 후 조건식을 확인 시 false가 나오면 바깥for문의 중괄호 안으로 들어간다
