...
public class SixPracticeMagicSquare {
	...
	public static void main(String[] args) {
		...
		//) 반복문1 (마방진의 넓이만큼 반복)
			...
			//) if(x == -1)(x좌표가 위로 올라가며 마방진을 벗어난 경우) : x 좌표를 마방진의 최하단으로 이동 ( x = 5(한변의길이) - 1 )
			//) if(y == 5(한 변의 길이))(y좌표가 오른쪽으로 이동하며 마방진을 벗어난 경우) : y 좌표를 마방진의 가장 왼쪽으로 이동 ( y = 0 )
		//) 반복문1 끝
		//) 반복문2 (2차원 배열의 크기만큼)
			//) 2차원 배열의 행을 담을 정수형 변수 선언
			//) 내부 반복문 (한 행의 열만큼 반복)
				//) 현재 위치의 숫자 출력
			//) 내부 반복문 끝
			//) 줄바꿈
