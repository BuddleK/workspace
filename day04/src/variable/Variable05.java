...
public class Variable05 {
	public static void main(String[] args) {
		...
		//같은 값을 여러곳에서 사용하거나 변경해야할 때 변수에서 저장하면 코드 수정이 간편해진다
		//변수값을 변경하면 해당 변수를 참조하는 모든 코드에 변경사항이 자동으로 적용된다
		
		int price = 200, quantity = 5;
		...
		// 변수에 이름을 붙이면 코드의 의미를 명확이 전달할 수 있다.
		...
		number = 10; // number. 상자에 10이라는 정수형 값을 저장, 이 number 상자는 RAMdptj xmrwjd wnthrkqtdmf rkwlsek
